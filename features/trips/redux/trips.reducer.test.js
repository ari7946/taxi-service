...
describe.skip('tripsReducer', () => {
  ...
  it('should get all trips in ascending order', () => {
    ...
    expect(
      tripsReducer(initialState, { type: TripsActionTypes.GET_TRIPS, trips: mockTrips }).trips
  ...
  it('should delete trip with id of 1', () => {
    ...
    expect(
      tripsReducer(mockState, { type: TripsActionTypes.DELETE_TRIP, trip: deletedTrip }).trips
