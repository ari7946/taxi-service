      ...
      <Container>
        <Row className="about-section">
          ...
          <Col className="order-first order-sm-2" sm={6}>
            <h3 className="about-heading">Cerritos yellow Cab</h3>
            <p className="about-description text-justify">Cerritos Yellow Cab offers efficient, reliable LA taxi service to meet the transportation needs of residents, visitors and our corporate clients. Our extensive service area includes Cerritos, Artesia, Norwalk, Santa Fe Springs, La Mirada, La Palma, Downey, Pico Rivera, Bellflower, Whittier, Hawaiian Gardens, Etc.</p>
          </Col>
        </Row>
