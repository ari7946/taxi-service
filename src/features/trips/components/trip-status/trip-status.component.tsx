...
const TripStatusButtons = function ({ tripId, tripStatus }: TripStatusProps) {
  ...
  const handleLoadingTrip = useSelector(
    (state: DefaultRootState) =>
      (tripId: number, tripStatus: TripStatus): boolean =>
    ...
    <>
      {authRole === 'admin' ? (
        <ButtonGroup color="light">
          ...
          <Button onClick={() => handleDeleteTrip('delete', tripId)}>
